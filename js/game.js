...
Game.prototype.dealCards = function(deck)
{
	...
	for(x=0; x<deck.length; x++)
	{
		...
		$("#" + id).append("<li class='card' data-role=" + x + "><figure class='front'><embed src='front.svg' type='image/svg+xml' /></figure><figure class='back'><embed src='"+deck[x].cardpath+"' type='image/svg+xml' /></figure></li>");
	}
}
